...
def render_start(request):
    ...
    return render(request, 'busterworld/start_page.html')
...
def render_game(request):
    ...
    return render(request, 'busterworld/game_page.html', template_arguments)
...
def render_high_scores(request):
    ...
    return render(request, 'busterworld/high_score_page.html', template_arguments)
